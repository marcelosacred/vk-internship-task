...
Поскольку ВК имеет свою экосистему, использование JWT вполне обоснованно.

Для текущего сервиса JWT дает простой и стандартный способ ограничить доступ к операциям выдачи пользователей без серверного хранения сессий. Это удобно для интеграций, автотестов и контейнерных окружений.
